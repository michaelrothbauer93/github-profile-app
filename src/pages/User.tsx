...
import { getUserAndRepos } from '../context/github/GithubServices';
  ...
  useEffect(() => {
    ...
    const getUserData = async () => {
      if (params && params.login) {
        const { user, userRepos } = await getUserAndRepos(params.login);

        dispatch({
          type: GithubUserActionTypes.SetUserAndRepos,
          payload: { user, userRepos },
        });
      }
    };
    getUserData();
